...
export function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand("jangxyz-esm-import-expression.copy-as-import-expression", async () => {
        ...
        try {
            ...
            vscode.window.showErrorMessage("Failed to copy selection: " + err.message);
        }
    });
